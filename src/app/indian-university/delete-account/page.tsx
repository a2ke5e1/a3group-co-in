    ...
    <>
      <Head>
        ...
        <meta property="og:image"
              content="https://www.a3group.co.in/eye-care/images/ss/Screenshot_1691238815.png"/>
        ...
        <meta name="twitter:image"
              content="https://www.a3group.co.in/eye-care/images/ss/Screenshot_1691238836.png"/>
      ...
      <main className={styles.main}>
        ...
        <p>In order to delete your account, contact us <a
          href="mailto:support@a3group.co.in">support@a3group.co.in</a></p>
        <p className={styles.disclaimer}>Your account will be deleted in 1 month after your intial data deletion
          request.<br/>We will send confirmation email after we recive your request.</p>
